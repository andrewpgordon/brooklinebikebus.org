...
Everything about *why*, so a new person — or a new Claude session — can pick
this up cold.
...
| `decisions.md` | Decision log. Twelve decisions with reasoning, including the ones argued both ways. |
